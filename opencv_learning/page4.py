...
class Cover(QtWidgets.QWidget):
    ...
    def set_ui(self):
        ...
        self.label_show_camera = QtWidgets.QPushButton()  # 定义进入按钮
        self.label_show_camera.setFont(QtGui.QFont("Roman times", 20, QtGui.QFont.Bold))
        self.label_show_camera.setStyleSheet("QPushButton{background-image: url(./imge/show.png);border-radius:5;}")
        self.label_show_camera.setFixedSize(1840, 1036)  # 设置按键尺寸
        #定义二维码标签
        self.qr = QtWidgets.QLabel()  # 定义显示标签
        self.qr.setFixedSize(148, 148)  # 设置标签尺寸
        # self.qr = QtWidgets.QPushButton()  # 定义进入按钮
        # self.qr.setFont(QtGui.QFont("Roman times", 20, QtGui.QFont.Bold))
        # self.qr.setStyleSheet("QPushButton{background-image: url(./imge/leimu.jpg;border-radius:5;}")
        # self.qr.setFixedSize(148, 148)  # 设置按键尺寸
        #返回按钮
        ...
        self.__layout_button.addItem(QtWidgets.QSpacerItem(-400, 0))
        self.__layout_button.addWidget(self.qr)
        self.__layout_button.addItem(QtWidgets.QSpacerItem(-600, 0))
